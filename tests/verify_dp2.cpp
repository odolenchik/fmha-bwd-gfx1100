...
__global__ void simple_dp_kernel(const half* dO, const half* V, half* dP,
                          int M, int N, int K) {
...
int main() {
    ...
    size_t dO_size = M * K * sizeof(half);
    size_t V_size  = N * K * sizeof(half);
    size_t dP_size = M * N * sizeof(half);
    ...
    // Simple test data
    half dO_h[16] = {__float2half_rn(1.0), __float2half_rn(2.0), __float2half_rn(3.0), __float2half_rn(4.0),
                     __float2half_rn(1.0), __float2half_rn(2.0), __float2half_rn(3.0), __float2half_rn(4.0),
                     __float2half_rn(1.0), __float2half_rn(2.0), __float2half_rn(3.0), __float2half_rn(4.0),
                     __float2half_rn(1.0), __float2half_rn(2.0), __float2half_rn(3.0), __float2half_rn(4.0)};
    half V_h[16]  = {__float2half_rn(1.0), __float2half_rn(1.0), __float2half_rn(1.0), __float2half_rn(1.0),
